    ...
    return (
      <div>
        <Router>
          ...
          />
          <Switch>
          <Route exact path="/"><News setProgress={this.setProgress}  pageSize={5} country={"in"} category={"general"} /></Route>
          ...
          <Route exact path="/technology"><News setProgress={this.setProgress}  key="science" pageSize={5} country={"in"} category={"technology"} /></Route>
